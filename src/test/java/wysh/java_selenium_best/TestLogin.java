...
//		// TODO Auto-generated catch block
//		e.printStackTrace();
//	}//*[@id="menuMainNav"]/li[6]/a
	WebElement testTabElement = driver.findElement(By.xpath("//*[@id=\"menuMainNav\"]/li[6]/a"));
...
//	 bugElement.click();
	  WebElement bugTabElement = driver.findElement(By.xpath("//*[@id=\"navbar\"]/ul/li[3]/a"));
	  bugTabElement.click();
	  try {
		  Thread.sleep(1000);
	  } catch (InterruptedException e) {
