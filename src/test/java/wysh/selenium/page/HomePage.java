...
public class HomePage extends BasePage{
     ...
     * @return WebElement
     */
    public WebElement getBugTabElement() {return element(getByLocator.getLocator("bugTabElement"));}
    /**
     * 获取产品下拉框按钮元素
     * @return WebElement
     */
    ...
    public WebElement getFrameElement1() {
        return element(getByLocator.getLocator("testFrameElement"));
    }
    /**
    ...
    public WebElement getFrameElement2() {
        return element(getByLocator.getLocator("frameElement"));
    }
    /**
     * 获取Bug详细信息输入框元素
     * @return WebElement
